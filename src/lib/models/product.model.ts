...
const PRODUCT_COLOR = ["red", "blue", "green", "black", "white", "yellow"];
const PRODUCT_DIS = ["0%", "10%", "20%", "30%", "40%", "above 40%"];
const PRODUCT_FABRIC = ["cotton", "silk", "georgette", "linen", "chiffon"];
const PRODUCT_PATTERN = ["embroided", "floral", "geometric", "abstract"];
...
const productSchema = new mongoose.Schema(
  {
    ...
    pDesc: { type: String },
    pSize: { type: String, enum: PRODUCT_SIZE, required: true },
    pImages: [{ type: String }],
    pCat: { type: String, enum: PRODUCT_CATEGORY, required: true },
    pColor: { type: String, enum: PRODUCT_COLOR },
