            ...
            <div className="flex items-center gap-3">
              ...
              {tier && (
                <motion.div
                  ...
                  className={`flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold shadow-md ${tierStyle.gradient} ${tierStyle.color}`}
                >
                  {tierStyle.icon}
                  {tierStyle.label}
                </motion.div>
          ...
          {sortedAndFiltered.map((p) => (
            ...
            >
              <div className="aspect-[4/3] overflow-hidden rounded-t-xl relative">
                ...
                />
                {tier === "Diamond" && (
                  <div className="absolute top-2 left-2 px-2 py-0.5 bg-sky-200 text-sky-800 text-xs font-semibold rounded-full flex items-center gap-1 shadow-sm">
                    <Gem className="w-3 h-3" /> Diamond
                  </div>
                )}
              </div>
