...
export function DashboardHeader({ userType, userName, userAvatar, title, description }: DashboardHeaderProps) {
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4 relative">
                        <div className="relative">
                            ...
                            >
                                {userAvatar ? (
                                    <Image src={userAvatar} alt={userName} className="h-full w-full object-cover" width={40} height={40} />
                                ) : (
                                    ...
                                    <div className="flex items-center gap-2 p-3 border-b border-gray-100">
                                        <div className="flex flex-col leading-tight">
                                            ...
                                            <p className="text-sm text-gray-500 truncate w-[200px]">
                                                {userType === "customer" ? "Customer Account" : "Lender Account"}
                                            </p>
                                        </div>
                                    </div>
                                    <div className="py-1">
